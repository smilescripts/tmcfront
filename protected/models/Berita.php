...
class Berita extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('judul_berita, isi_berita, tanggal_posting, oleh_petugas, status, kategori_berita', 'required'),
			array('kategori_berita', 'numerical', 'integerOnly'=>true),
	...
	public function search()
	{
		...
		$criteria->compare('judul_berita',$this->judul_berita,true);
