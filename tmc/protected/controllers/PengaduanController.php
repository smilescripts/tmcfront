...
class PengaduanController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Pengaduan']))
		{
			...
			if($model->save())
				$this->redirect(array('view','id'=>$model->kode_pengaduan));
		}
	...
	{
		$JenisPengaduan=new JenisPengaduan('search');
		$JenisPengaduan->unsetAttributes();  // clear any default values
		if(isset($_GET['JenisPengaduan']))
			$JenisPengaduan->attributes=$_GET['JenisPengaduan'];
	 ...
	 * @param Pengaduan $model the model to be validated
	 */
